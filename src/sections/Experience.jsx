...
const Experience = () => {
  useGSAP(() => {
    ...
    if (isMobile) return; // desactiva animaciones pesadas en móviles
              ...
              >
                ...
                <div className="xl:w-4/6 w-full">
                  <div className="flex items-start gap-5 md:gap-10 xl:gap-20">
                    <div className="timeline-wrapper absolute top-0 xl:left-[35.5vw] md:left-10 left-4 h-full flex justify-center">
                      <div className="timeline w-2 md:w-6 h-[110%] -top-10 bg-black absolute z-30" />
                      <div className="gradient-line w-1 h-full" />
                    </div>
                    <div className="expText flex flex-col gap-4 relative z-20 w-full">
